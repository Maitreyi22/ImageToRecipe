...
import 'package:projectapp/not_found_page.dart';
  ...
  void readMyRecipe() async {
    ...
    if (documentSnapshot.data() == null) {
      setState(() {
        // isWorking = false;
        Navigator.push(
            context, MaterialPageRoute(builder: (_) => const NotFoundPage()));
      });
    } else {
      setState(() {
                    ...
                    children: [
                            ...
                            SizedBox(
                              child: Chip(
                                ...
                                label: Text(
                                  ...
                                  difficultyLevel ?? "difficulty level is null",
                                  style: const TextStyle(
                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          stringList_ing ?? "Ingredients is Null",
                            ...
                            child: SizedBox(
                              child: Chip(
                                ...
                                label: Text(
                                  ...
                                  approxTime ?? "Approx time is null",
                                  style: const TextStyle(
                                      fontSize: 14, color: Color(0xFFD78915)),
                                ), //Text
                              ),
