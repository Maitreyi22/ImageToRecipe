                              ...
                              SizedBox(
                                child: Chip(
                                  avatar: Container(
                                    ...
                                    child: ClipRRect(
                                      child:
                                          Image.asset('images/Difficulty.png'),
                                    ),
                                  ),
                                ...
                                child: SizedBox(
                                  child: Chip(
                                    avatar: Container(
                                      ...
                                      child: ClipRRect(
                                        child:
                                            Image.asset('images/Calorie.png'),
                                      ),
                                    ),
                                    backgroundColor: Colors.white,
                                    shape: const RoundedRectangleBorder(
